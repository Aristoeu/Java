...
public class RegressionTest10 {
    ...
    public void test5191() throws Throwable {
        ...
        int int15 = linkedQueue0.size();
        boolean boolean16 = linkedQueue0.isEmpty();
        boolean boolean18 = linkedQueue0.enqueue(2);
        org.junit.Assert.assertTrue("'" + int1 + "' != '" + 0 + "'", int1 == 0);
        org.junit.Assert.assertTrue("'" + boolean3 + "' != '" + true + "'", boolean3 == true);
        org.junit.Assert.assertTrue("'" + boolean5 + "' != '" + true + "'", boolean5 == true);
        org.junit.Assert.assertTrue("'" + int6 + "' != '" + 2 + "'", int6 == 2);
    ...
    public void test5212() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + int13 + "' != '" + 0 + "'", int13 == 0);
        org.junit.Assert.assertTrue("'" + boolean15 + "' != '" + true + "'", boolean15 == true);
        org.junit.Assert.assertEquals("'" + str16 + "' != '" + "[0, 100, 0, 4]" + "'", str16, "[0, 100, 0, 4]");
    }
    ...
    public void test5217() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + int9 + "' != '" + 0 + "'", int9 == 0);
        org.junit.Assert.assertTrue("'" + boolean11 + "' != '" + true + "'", boolean11 == true);
        org.junit.Assert.assertEquals("'" + str12 + "' != '" + "[0, 100, 35]" + "'", str12, "[0, 100, 35]");
        org.junit.Assert.assertTrue("'" + int13 + "' != '" + 0 + "'", int13 == 0);
    }
    ...
    public void test5226() throws Throwable {
        ...
        boolean boolean25 = linkedQueue0.isEmpty();
        linkedQueue0.clear();
        org.junit.Assert.assertTrue("'" + int1 + "' != '" + 0 + "'", int1 == 0);
        org.junit.Assert.assertTrue("'" + boolean3 + "' != '" + true + "'", boolean3 == true);
        org.junit.Assert.assertEquals("'" + str4 + "' != '" + "[0]" + "'", str4, "[0]");
    ...
    public void test5246() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + int6 + "' != '" + 0 + "'", int6 == 0);
        org.junit.Assert.assertTrue("'" + boolean8 + "' != '" + true + "'", boolean8 == true);
        org.junit.Assert.assertEquals("'" + str9 + "' != '" + "[2, 97]" + "'", str9, "[2, 97]");
    }
    ...
    public void test5272() throws Throwable {
        ...
        org.junit.Assert.assertEquals("'" + str7 + "' != '" + "[0]" + "'", str7, "[0]");
        org.junit.Assert.assertTrue("'" + boolean9 + "' != '" + true + "'", boolean9 == true);
        org.junit.Assert.assertEquals("'" + str10 + "' != '" + "[0, 3]" + "'", str10, "[0, 3]");
    }
    ...
    public void test5284() throws Throwable {
        ...
        int int18 = linkedQueue0.peekRear();
        int int19 = linkedQueue0.size();
        boolean boolean21 = linkedQueue0.enqueue(0);
        org.junit.Assert.assertTrue("'" + int1 + "' != '" + 0 + "'", int1 == 0);
        org.junit.Assert.assertTrue("'" + boolean3 + "' != '" + true + "'", boolean3 == true);
        org.junit.Assert.assertEquals("'" + str4 + "' != '" + "[0]" + "'", str4, "[0]");
        org.junit.Assert.assertTrue("'" + boolean6 + "' != '" + true + "'", boolean6 == true);
    ...
    public void test5285() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + boolean10 + "' != '" + false + "'", boolean10 == false);
        org.junit.Assert.assertTrue("'" + boolean12 + "' != '" + true + "'", boolean12 == true);
        org.junit.Assert.assertEquals("'" + str13 + "' != '" + "[0, 4]" + "'", str13, "[0, 4]");
    }
    ...
    public void test5291() throws Throwable {
        ...
        java.lang.String str17 = linkedQueue0.toString();
        int int18 = linkedQueue0.dequeue();
        boolean boolean20 = linkedQueue0.enqueue(4);
        org.junit.Assert.assertTrue("'" + int1 + "' != '" + 0 + "'", int1 == 0);
        org.junit.Assert.assertTrue("'" + boolean3 + "' != '" + true + "'", boolean3 == true);
        org.junit.Assert.assertEquals("'" + str4 + "' != '" + "[0]" + "'", str4, "[0]");
        org.junit.Assert.assertTrue("'" + boolean6 + "' != '" + true + "'", boolean6 == true);
    ...
    public void test5311() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + int11 + "' != '" + 0 + "'", int11 == 0);
        org.junit.Assert.assertTrue("'" + boolean13 + "' != '" + true + "'", boolean13 == true);
        org.junit.Assert.assertEquals("'" + str14 + "' != '" + "[0, 52]" + "'", str14, "[0, 52]");
        org.junit.Assert.assertTrue("'" + int15 + "' != '" + 2 + "'", int15 == 2);
    }
    ...
    public void test5321() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + boolean7 + "' != '" + true + "'", boolean7 == true);
        org.junit.Assert.assertTrue("'" + int8 + "' != '" + 97 + "'", int8 == 97);
        org.junit.Assert.assertEquals("'" + str9 + "' != '" + "[10, 97]" + "'", str9, "[10, 97]");
    }
    ...
    public void test5351() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + int14 + "' != '" + 4 + "'", int14 == 4);
        org.junit.Assert.assertTrue("'" + boolean15 + "' != '" + false + "'", boolean15 == false);
        org.junit.Assert.assertEquals("'" + str16 + "' != '" + "[0, 0, 0, -1]" + "'", str16, "[0, 0, 0, -1]");
    }
    ...
    public void test5359() throws Throwable {
        ...
        int int18 = linkedQueue0.size();
        boolean boolean19 = linkedQueue0.isEmpty();
        boolean boolean21 = linkedQueue0.enqueue((int) (short) 0);
        org.junit.Assert.assertTrue("'" + int1 + "' != '" + 0 + "'", int1 == 0);
        org.junit.Assert.assertTrue("'" + boolean3 + "' != '" + true + "'", boolean3 == true);
        org.junit.Assert.assertEquals("'" + str4 + "' != '" + "[0]" + "'", str4, "[0]");
        org.junit.Assert.assertTrue("'" + boolean6 + "' != '" + true + "'", boolean6 == true);
    ...
    public void test5378() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + boolean16 + "' != '" + true + "'", boolean16 == true);
        org.junit.Assert.assertTrue("'" + int17 + "' != '" + 10 + "'", int17 == 10);
        org.junit.Assert.assertEquals("'" + str18 + "' != '" + "[0, 0, 10]" + "'", str18, "[0, 0, 10]");
    }
    ...
    public void test5397() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + int12 + "' != '" + 2 + "'", int12 == 2);
        org.junit.Assert.assertTrue("'" + int13 + "' != '" + 2 + "'", int13 == 2);
        org.junit.Assert.assertEquals("'" + str14 + "' != '" + "[0, 100, 2]" + "'", str14, "[0, 100, 2]");
        org.junit.Assert.assertNotNull(wildcardClass15);
    }
    ...
    public void test5403() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + boolean19 + "' != '" + false + "'", boolean19 == false);
        org.junit.Assert.assertTrue("'" + int20 + "' != '" + 0 + "'", int20 == 0);
        org.junit.Assert.assertEquals("'" + str21 + "' != '" + "[0, 100]" + "'", str21, "[0, 100]");
    }
    ...
    public void test5409() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + int7 + "' != '" + 32 + "'", int7 == 32);
        org.junit.Assert.assertTrue("'" + boolean8 + "' != '" + false + "'", boolean8 == false);
        org.junit.Assert.assertEquals("'" + str9 + "' != '" + "[32, 100]" + "'", str9, "[32, 100]");
        org.junit.Assert.assertTrue("'" + int10 + "' != '" + 2 + "'", int10 == 2);
    }
    ...
    public void test5418() throws Throwable {
        ...
        org.junit.Assert.assertEquals("'" + str15 + "' != '" + "[0, 0, 100]" + "'", str15, "[0, 0, 100]");
    }
    ...
    public void test5431() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + boolean19 + "' != '" + false + "'", boolean19 == false);
        org.junit.Assert.assertTrue("'" + int20 + "' != '" + 0 + "'", int20 == 0);
        org.junit.Assert.assertEquals("'" + str21 + "' != '" + "[0, 0, 100, 52]" + "'", str21, "[0, 0, 100, 52]");
    }
    ...
    public void test5445() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + boolean18 + "' != '" + true + "'", boolean18 == true);
        org.junit.Assert.assertEquals("'" + str19 + "' != '" + "[100, 0, 52]" + "'", str19, "[100, 0, 52]");
    ...
    public void test5462() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + boolean15 + "' != '" + true + "'", boolean15 == true);
        org.junit.Assert.assertTrue("'" + boolean17 + "' != '" + true + "'", boolean17 == true);
        org.junit.Assert.assertEquals("'" + str18 + "' != '" + "[0, 0, 10, -1, 1, 35]" + "'", str18, "[0, 0, 10, -1, 1, 35]");
    ...
    public void test5467() throws Throwable {
        ...
        java.lang.String str13 = linkedQueue0.toString();
        int int14 = linkedQueue0.size();
        boolean boolean16 = linkedQueue0.enqueue(52);
        boolean boolean17 = linkedQueue0.isEmpty();
        org.junit.Assert.assertTrue("'" + int1 + "' != '" + 0 + "'", int1 == 0);
        org.junit.Assert.assertTrue("'" + boolean3 + "' != '" + true + "'", boolean3 == true);
        org.junit.Assert.assertEquals("'" + str4 + "' != '" + "[0]" + "'", str4, "[0]");
    ...
    public void test5495() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + int13 + "' != '" + 32 + "'", int13 == 32);
        org.junit.Assert.assertTrue("'" + int14 + "' != '" + 0 + "'", int14 == 0);
        org.junit.Assert.assertEquals("'" + str15 + "' != '" + "[100, 32]" + "'", str15, "[100, 32]");
    }
    ...
    public void test5498() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + boolean10 + "' != '" + true + "'", boolean10 == true);
        org.junit.Assert.assertTrue("'" + int11 + "' != '" + 0 + "'", int11 == 0);
        org.junit.Assert.assertEquals("'" + str12 + "' != '" + "[2, 32]" + "'", str12, "[2, 32]");
    }
